  ...
  return (
    <AntTabs defaultActiveKey="1">
      <TabPane tab="General Info" key="1">
        <GeneralInfoForm userId={userId} {...props} />
      </TabPane>
      <TabPane tab="Permissions" key="2">
        <PermissionsForm userId={userId} {...props} />
      </TabPane>
      <TabPane tab="Instance Access" key="3">
        <InstanceAccessForm userId={userId} {...props} />
      </TabPane>
    </AntTabs>
  );
};
...
export default WithBreadcrumbs(['Admin', 'Users', 'Edit'])(EditForm as any);
