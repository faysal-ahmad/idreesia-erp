...
import type { PagedAttendanceByHrPersonQuery } from 'meteor/idreesia-common/types/client-operations';
...
type AttendanceRow = NonNullable<
  NonNullable<NonNullable<PagedAttendanceByHrPersonQuery['pagedAttendanceByKarkun']>['data']>[number]
>;
