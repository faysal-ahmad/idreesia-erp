...
class NewForm extends Component {
  static propTypes = {
    ...
    createSecurityMehfilDuty: PropTypes.func,
  };
  ...
  handleFinish = fieldsValue => {
    const { createSecurityMehfilDuty, history } = this.props;
...
export default flowRight(
  graphql(formMutation, {
    name: 'createSecurityMehfilDuty',
    options: {
      refetchQueries: ['allSecurityMehfilDuties'],
    },
  }),
  WithBreadcrumbs(['Security', 'Mehfil Duties', 'New'])
)(NewForm);
