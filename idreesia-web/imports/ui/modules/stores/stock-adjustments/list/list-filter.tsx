...
const ListFilter = ({ refreshPage, refreshData, queryParams }: Props) => {
  const { startDate, endDate, showApproved, showUnapproved } = queryParams;
  ...
  return (
    <Collapse
      ...
      items={[{
        ...
        children: (
          <Form layout="horizontal" onFinish={({ approvalStatus, startDate: s, endDate: e }) => refreshPage({ approvalStatus, startDate: s, endDate: e, pageIndex: 0 })}>
            ...
            <Form.Item {...buttonItemLayout}>
              <Row justify="end">
                <Button type="default" onClick={() => refreshPage({ approvalStatus: ['approved', 'unapproved'], startDate: null, endDate: null, pageIndex: 0 })}>Reset</Button>
                &nbsp;
