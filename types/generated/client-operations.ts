...
export type AttendanceByBarcodeIdQueryVariables = Exact<{
  barcodeId: string;
}>;


export type AttendanceByBarcodeIdQuery = { attendanceByBarcodeId: { _id: string | null, karkunId: string | null, dutyId: string | null, shiftId: string | null, month: string | null, absentCount: number | null, presentCount: number | null, percentage: number | null, karkun: { _id: string | null, name: string | null, cnicNumber: string | null, contactNumber1: string | null, imageId: string | null } | null, duty: { _id: string | null, name: string | null } | null, shift: { _id: string | null, name: string | null } | null, job: { _id: string | null, name: string | null } | null } | null };
...
export type SetKarkunEmploymentInfoMutationVariables = Exact<{
  _id: string;
  isEmployee: boolean;
...
export type SetKarkunEmploymentInfoMutation = { setHrKarkunEmploymentInfo: { _id: string | null, isEmployee: boolean | null, jobId: string | null, employmentStartDate: string | null, employmentEndDate: string | null, bankAccountDetails: string | null } | null };
...
export type SetHrKarkunWazaifAndRaabtaMutationVariables = Exact<{
  _id: string;
  lastTarteebDate?: string | null | undefined;
  mehfilRaabta?: string | null | undefined;
  msRaabta?: string | null | undefined;
}>;


export type SetHrKarkunWazaifAndRaabtaMutation = { setHrKarkunWazaifAndRaabta: { _id: string | null, lastTarteebDate: string | null, mehfilRaabta: string | null, msRaabta: string | null } | null };
...
export type PagedAttendanceByHrPersonQueryVariables = Exact<{
  queryString?: string | null | undefined;
}>;


export type PagedAttendanceByHrPersonQuery = { pagedAttendanceByKarkun: { totalResults: number | null, data: Array<{ _id: string | null, dutyId: string | null, shiftId: string | null, jobId: string | null, month: string | null, absentCount: number | null, presentCount: number | null, percentage: number | null, job: { _id: string | null, name: string | null } | null, duty: { _id: string | null, name: string | null } | null, shift: { _id: string | null, name: string | null } | null } | null> | null } | null };
...
export type ApproveAllSalariesMutationVariables = Exact<{
  month: string;
}>;


export type ApproveAllSalariesMutation = { approveAllSalaries: number | null };

export type ApproveSalariesMutationVariables = Exact<{
  month: string;
  ids: Array<string | null | undefined> | string;
}>;


export type ApproveSalariesMutation = { approveSalaries: number | null };
...
export type InventoryStatisticsQueryVariables = Exact<{
  physicalStoreId: string;
}>;
